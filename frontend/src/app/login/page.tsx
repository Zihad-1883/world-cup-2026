  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        // Check for guest picks to submit
    ...
    <div className="min-h-screen bg-[#0a0c10] flex flex-col items-center justify-center p-6 relative overflow-hidden selection:bg-green-500 selection:text-black">
      ...
      <div className="w-full max-w-md glass-panel rounded-[40px] border border-white/5 p-10 shadow-2xl relative overflow-hidden group/card z-10">
        ...
        <div className="relative z-10">
          <h2 className="nike-title text-3xl text-white italic tracking-tighter mb-2">Welcome <span className="text-green-500">Back</span></h2>
          <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px] mb-10">Access your prediction command center.</p>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative group/input">
              ...
              <input
                ...
                placeholder="PRO_USERNAME@EMAIL.COM"
              />
            </div>
          </div>
        ...
        <div className="mt-10 pt-10 border-t border-white/5 text-center relative z-10">
          <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest">
            New Prospect?{' '}
            <Link href="/register" className="text-green-500 hover:text-white transition-colors ml-2 underline underline-offset-4">
              Join the Elite
            </Link>
          </p>
        </div>
